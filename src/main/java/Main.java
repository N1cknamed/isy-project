...
//        PlayerFactoryBuilder playerFactoryBuilder = Ttt.getPlayerFactoryBuilder();
    ...
    private static void runBattleshipCli() {
        ...
        GameController controller = new GameController(game, BattleshipRandomPlayer::new, BattleshipBoatPlacementPlayer::new);
...
//            GameController controller = new GameController(game, BattleshipRandomPlayer::new, new BattleshipPlayerFactory());
            GameController controller = new GameController(game, BattleshipBoatPlacementPlayer::new, new BattleshipPlayerFactory());
